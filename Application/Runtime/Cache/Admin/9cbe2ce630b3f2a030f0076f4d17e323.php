...
<head>
    ...
    <link href="/me/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/me/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/me/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/me/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/me/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/me/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/me/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
    ...
    <script type="text/javascript" src="/me/Public/static/think.js"></script>
    <script type="text/javascript" src="/me/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/me/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/me/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/me/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/me/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/me/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
