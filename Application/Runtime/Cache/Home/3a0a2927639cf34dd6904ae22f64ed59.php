...
<div id="main-container" class="container">
	...
	<div>
		<div class="center" >
		<h2 style="margin-left: 40%;">记录点滴 品味生活</h2>
			<!--<img src="/me/Public/Home/images/bc.jpg" style="width: 100%;height: 100px;">-->
		</div>
		<div class="righc">
			<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><ul>
					<li><a href="<?php echo U('Share/lonk?id='.$cate['id']);?>" title="<?php echo ($cate["title"]); ?>" style="cursor: pointer; color: #000;"> <?php echo ($cate["title"]); ?></a> <span style="display: block; float: right;"><?php echo (date('Y-m-d H:i',$cate["creat_time"])); ?></span></li>
